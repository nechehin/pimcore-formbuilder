CREATE TABLE IF NOT EXISTS `formbuilder_forms` (
  ...
  `configuration` longtext COMMENT '(DC2Type:form_builder_serialized)',
  `conditionalLogic` longtext COMMENT '(DC2Type:form_builder_serialized)',
...
CREATE TABLE IF NOT EXISTS `formbuilder_output_workflow` (
  ...
  `success_management` longtext COMMENT '(DC2Type:form_builder_serialized)',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `formbuilder_output_workflow_channel` (
  ...
  `configuration` longtext COMMENT '(DC2Type:form_builder_serialized)',
  `funnel_actions` longtext COMMENT '(DC2Type:form_builder_serialized)',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `formbuilder_double_opt_in_session` (
    ...
    `additional_data` longtext NULL COMMENT '(DC2Type:form_builder_serialized)',
